                ...
                <div align="center" class="formcon">
                    ...
                    <div class="form-group mb-1">
                      ...
                      <div class="form-group mb-4" style="margin-top: 40px">
                        ...
                        <input style="width: 60%; background: transparent; border-width: 3px; border-top: none; border-left: none; border-right: none;" type="password" placeholder="Masukan Password" class="form-control mt-2" id="exampleInputPassword1" name="password">
                      </div>
      
                      <div class="buttoncon">
                        <button type="submit" style="width: 60%;" type="submit" class="btn btn-primary mt-3">
                            {{ __('Login') }}
                        </button>
