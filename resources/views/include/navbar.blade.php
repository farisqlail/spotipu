<nav class="navbar navbar-expand topbar mb-4 static-top">
    ...
    <!-- Topbar Search -->
    <form action="{{ route('music.search') }}" method="GET" class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
    ...
    <ul class="navbar-nav ml-auto">
        ...
        @if (Auth::check())
                    ...
                    <form class="form-inline mr-auto w-100 navbar-search">
                        <div class="input-group">
                            <input type="text" class="form-control bg-light border-0 small"
                                placeholder="Cari lagu favoritmu ..." aria-label="Search"
            ...
            <li class="nav-item dropdown no-arrow mx-1">
                <a class="nav-link dropdown-toggle" href="#" id="alertsDropdown" role="button" data-toggle="dropdown"
                    aria-haspopup="true" aria-expanded="false">
                    <i class="far fa-bell fa-fw text-white"></i>
                    <!-- Counter - Alerts -->
        ...
        @else
            <a href="{{ route('login') }}" class="btn btn-outline-warning hvr-grow mt-3"
