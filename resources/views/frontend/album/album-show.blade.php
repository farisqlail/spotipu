        ...
        <div class="col-md-3" align="center">
            <div class="card" style="background-color: #2D3E50; border: none; ">
                <div class="card-body">
                    ...
                    <a href="{{ route('artist.show', $music[0]->id_artis) }}" class="text-muted"><small>{{ $music[0]->name_artis }}</small></a><br>
                    <img src="{{ asset('storage/album/cover/' . $music[0]->cover) }}" class="img-fluid rounded mt-3"
