...
@section('content')
    ...
    @if ($music == null)
            ...
            <div class="row">
                <div class="col-md-3" align="center">
                    <div class="card" style="background-color: #2D3E50; border: none; ">
                        <div class="card-body">
                            <h2 class="text-white"><strong>{{ $music[0]->name_album }}</strong></h2>
                            <a href="{{ route('artist.show', $music[0]->id_artis) }}"
                                class="text-muted"><small>{{ $music[0]->name_artis }}</small></a><br>
                            <img src="{{ asset('storage/album/cover/' . $music[0]->cover) }}"
                                class="img-fluid rounded mt-3" width="150" style="height: 170px;">

                            <p class="mt-3">
                                {!! $music[0]->description_album !!}
                            </p>
                        </div>
                    </div>
                                ...
                                <div class="row mt-5">
                                    ...
                                    <div class="col-md-2 mr-auto">
                                        <img src="{{ asset('storage/music/cover/' . $data->cover_music) }}"
                                            class="img-fluid" width="80" srcset="">
                                    </div>
        ...
        @else
            <h3 class="text-center text-white mt-5">Data Belum Ada</h3>
    @endif
